...
export const VIDEO_MENU: NavigationMenu = {
  ...
  models: [
    { id: 'higgsfield-dop', label: 'Higgsfield DOP', provider: 'Higgsfield', isComingSoon: true, description: 'Cinematic depth-of-field video' },
    { id: 'grok-imagine', label: 'Grok Imagine', provider: 'xAI', badge: 'new', isComingSoon: true, description: 'AI video from xAI' },
    { id: 'kling-3.0', label: 'Kling 3.0', provider: 'Kuaishou', badge: 'new', isComingSoon: true, description: 'Next-gen Kling video model' },
    { id: 'kling-motion-control', label: 'Kling Motion Control', provider: 'Kuaishou', badge: 'new', isComingSoon: true, description: 'Precise motion-guided generation' },
    ...
    { id: 'kling-3.0-omni-edit', label: 'Kling 3.0 Omni Edit', provider: 'Kuaishou', badge: 'new', isComingSoon: true, description: 'All-in-one video editing' },
    { id: 'kling-o1-edit', label: 'Kling O1 Edit', provider: 'Kuaishou', isComingSoon: true, description: 'AI-powered video editing' },
    { id: 'sora-2', label: 'Sora 2', provider: 'OpenAI', isComingSoon: true, description: 'OpenAI cinematic video model' },
    ...
    { id: 'wan-2.6', label: 'Wan 2.6', provider: 'Alibaba', isComingSoon: true, description: 'Alibaba video generation' },
    ...
    { id: 'kling-avatars-2.0', label: 'Kling Avatars 2.0', provider: 'Kuaishou', isComingSoon: true, description: 'AI avatar video generation' },
  ],
}
...
export const IMAGE_MENU: NavigationMenu = {
  ...
  models: [
    { id: 'higgsfield-soul', label: 'Higgsfield Soul', provider: 'Higgsfield', badge: 'best', isComingSoon: true, description: 'Ultra-realistic portrait generation' },
    { id: 'higgsfield-popcorn', label: 'Higgsfield Popcorn', provider: 'Higgsfield', isComingSoon: true, description: 'Fast creative image generation' },
    { id: 'nano-banana-pro', label: 'Nano Banana Pro', provider: 'Nano', badge: 'top', isComingSoon: true, description: 'High-speed image model' },
    ...
    { id: 'z-image', label: 'Z-Image', provider: 'Various', isComingSoon: true, description: 'Multi-provider image fusion' },
    { id: 'kling-q1-image', label: 'Kling Q1 Image', provider: 'Kuaishou', isComingSoon: true, description: 'Kling image generation model' },
    { id: 'wan-2.2-image', label: 'Wan 2.2 Image', provider: 'Alibaba', isComingSoon: true, description: 'Alibaba image generation' },
    { id: 'reve', label: 'Reve', provider: 'Reve', isComingSoon: true, description: 'Artistic image creation' },
    { id: 'topaz', label: 'Topaz', provider: 'Topaz Labs', isComingSoon: true, description: 'AI-enhanced image processing' },
  ],
}
...
export const EDIT_MENU: NavigationMenu = {
  ...
  models: [
    { id: 'nano-banana-pro-inpaint', label: 'Nano Banana Pro Inpaint', provider: 'Nano', isComingSoon: true, description: 'Advanced inpainting model' },
    { id: 'nano-banana-inpaint', label: 'Nano Banana Inpaint', provider: 'Nano', isComingSoon: true, description: 'Fast inpainting model' },
    { id: 'product-placement', label: 'Product Placement', provider: 'Various', isComingSoon: true, description: 'AI product placement in scenes' },
    { id: 'topaz-edit', label: 'Topaz', provider: 'Topaz Labs', isComingSoon: true, description: 'AI-enhanced editing tools' },
    { id: 'grok-imagine-edit', label: 'Grok Imagine Edit', provider: 'xAI', badge: 'new', isComingSoon: true, description: 'xAI-powered image editing' },
    { id: 'kling-3.0-omni-edit', label: 'Kling 3.0 Omni Edit', provider: 'Kuaishou', badge: 'top', isComingSoon: true, description: 'All-in-one editing model' },
    { id: 'kling-o1-edit', label: 'Kling O1 Edit', provider: 'Kuaishou', badge: 'top', isComingSoon: true, description: 'Intelligent video editing' },
  ],
}
...
export const CHARACTER_MENU: NavigationMenu = {
  ...
  models: [
    { id: 'soul-id-character', label: 'Soul ID Character', provider: 'Higgsfield', isComingSoon: true, description: 'Consistent character identity' },
  ],
}
