...
export const VIDEO_MENU: NavigationMenu = {
  ...
  models: [
    ...
    { id: 'grok-imagine', label: 'Grok Imagine', provider: 'xAI', badge: 'new', toolId: 'generate_video_by_grok_imagine_xai', description: 'AI video from xAI' },
    ...
    { id: 'kling-motion-control', label: 'Kling Motion Control', provider: 'Kuaishou', badge: 'new', toolId: 'generate_video_by_kling_v26_motion_control_replicate', description: 'Precise motion-guided generation' },
    { id: 'kling-2.6', label: 'Kling 2.6', provider: 'Kuaishou', toolId: 'generate_video_by_kling_v26_replicate', description: 'High-quality video generation' },
    ...
    { id: 'sora-2', label: 'Sora 2', provider: 'OpenAI', toolId: 'generate_video_by_sora_openai', description: 'OpenAI cinematic video model' },
    { id: 'veo-3.1', label: 'Google Veo 3.1', provider: 'Google', toolId: 'generate_video_by_veo_google', description: 'Google DeepMind video model' },
    { id: 'seedance-1.5-pro', label: 'Seedance 1.5 Pro', provider: 'ByteDance', toolId: 'generate_video_by_seedance_v1_pro_volces', description: 'ByteDance motion generation' },
    ...
    { id: 'kling-avatars-2.0', label: 'Kling Avatars 2.0', provider: 'Kuaishou', toolId: 'generate_video_by_kling_avatar_v2_replicate', description: 'AI avatar video generation' },
...
export const IMAGE_MENU: NavigationMenu = {
  ...
  models: [
    ...
    { id: 'seedream-4.5', label: 'Seedream 4.5', provider: 'ByteDance', badge: 'new', toolId: 'generate_image_by_doubao_seedream_3_volces', description: 'ByteDance image generation' },
    { id: 'gpt-image-1.5', label: 'GPT Image 1.5', provider: 'OpenAI', toolId: 'generate_image_by_gpt_image_openai', description: 'OpenAI image model' },
    { id: 'flux-2', label: 'FLUX.2', provider: 'Black Forest Labs', badge: 'new', toolId: 'generate_image_by_flux_kontext_max_replicate', description: 'State-of-the-art image synthesis' },
